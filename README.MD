  **cmpe283 assignment1 -Completed as an INDIVIDUAL **
     ...
     Setup the Ubuntu Machine with Linux kernel source code
 ...
 **Build the Linux kernel and Install missing modules while building the kernel.**
     ...
     Failed ! installed few more modules below
     ...
     created certs : openssl req -x509 -newkey rsa:4096 -keyout certs/mycert.pem -out certs/mycert.pem -nodes -days 3650
   ...
   **Create a.c file that will be used to find the capabilities of the  MSR's.**
     ...
     - vim cmpe283-1.c
     - File contents
     - https://github.com/mayurigupta01/linux/blob/master/cmpe283/cmpe283-1.c
   ...
   **Veridy the message log in kernel output.**
   ...
   **Verify the Output**
   ...
   - https://github.com/mayurigupta01/linux/blob/master/cmpe283-1-output 
   ...
   **Commit changes to GitHub** 
    ...
    - sudo rmmod cmpe283-1
     Clean up the module from kernel , since it is built already it does not need to build again.
