...
**Create a Nested Virtual Machine**
 ...
 <img width="468" alt="image" src="https://user-images.githubusercontent.com/89235391/141696226-80a8b00d-14ee-4db5-81e6-6faff9be9513.png">
...
**Error on launching the VM  , after troubleshoot figured out that qemu-Kvm is using the old version and sudo apt 
    ...
    To fix the issue followed the -	https://wiki.qemu.org/Hosts/Linux and created a VM inside the VM.
    ...
    On vnc viewer viewed the nested VM .
